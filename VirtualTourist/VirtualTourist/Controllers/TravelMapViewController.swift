...
class TravelMapViewController: UIViewController, MKMapViewDelegate {
    ...
    private func loadAllPins() -> [Pin]? {
        ...
        do {
            ...
            showInfo(withTitle: "Error", withMessage: "Error while fetching Pin : \(error)")
        }
        return pins
    }
    ...
    private func loadPin(latitude: String, longitude: String) -> Pin? {
        ...
        do {
            ...
            showInfo(withTitle: "Error", withMessage: "Error while fetching : \(error)")
        }
        return pin
    }
...
extension TravelMapViewController {
    ...
    func mapView(_ mapView: MKMapView, annotationView view: MKAnnotationView, calloutAccessoryControlTapped control: UIControl) {
        if control == view.rightCalloutAccessoryView {
            self.showInfo(withMessage: "No url founded.")
        }
    }
