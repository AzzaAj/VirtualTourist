...
extension PhotoAlbumViewController: UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView, willDisplay cell: UICollectionViewCell, forItemAt indexPath: IndexPath) {
        ...
        configImg(using: photoViewCell, photo: photo, collectionView: collectionView, index: indexPath)
    }
    ...
    private func configImg(using cell: PhotoViewCell, photo: Photo, collectionView: UICollectionView, index: IndexPath) {
        if let imageData = photo.image {
            ...
            if let imageUrl = photo.imageUrl {
                cell.activityIndicator.startAnimating()
                Client.shared().downloadIm(imageUrl: imageUrl) { (data, error) in
                    if let _ = error {
